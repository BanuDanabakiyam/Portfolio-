...
const MovingImg = ({title,img,link}) => {
    ...
    return(
        ...
        >
            ...
            src={img} ref={imgRef} alt="title" className="z-10 w-96 h-auto hidden absolute rounded-lg md:!hidden"></FramerImage>
            </Link>
...
const Article = ({img,title,date,link}) => {
    return(
        ...
        ">
            ...
            <span className="text-primary font-semibold pl-4 dark:text-primaryDark sm:self-start sm:p1-0 xs:text-sm">{date}</span>
        </motion.li>
    );
}
